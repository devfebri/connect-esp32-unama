...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* accent colors */
        .acc-green .sensor-card:hover {
            border-color: rgba(52, 211, 153, .45);
            box-shadow: 0 8px 28px rgba(52, 211, 153, .12);
        }

        .acc-blue .sensor-card:hover {
            border-color: rgba(96, 165, 250, .45);
            box-shadow: 0 8px 28px rgba(96, 165, 250, .12);
        }

        .acc-purple .sensor-card:hover {
            border-color: rgba(167, 139, 250, .45);
            box-shadow: 0 8px 28px rgba(167, 139, 250, .12);
        }

        .acc-amber .sensor-card:hover {
            border-color: rgba(251, 191, 36, .45);
            box-shadow: 0 8px 28px rgba(251, 191, 36, .12);
        }

        .acc-cyan .sensor-card:hover {
...
<body>
    ...
    <main class="main">
        ...
        <div class="summary-row">
            <div class="sum-card">
                <div class="sum-icon" style="color:var(--green)">🌱</div>
                <div>
                    <div class="sum-label">Kel. Tanah (rata²)</div>
                    <div class="sum-val" id="sum-soil">— %</div>
                </div>
            </div>
            <div class="sum-card">
                <div class="sum-icon" style="color:var(--blue)">🌡️</div>
                <div>
                    <div class="sum-label">Suhu Udara (rata²)</div>
                    <div class="sum-val" id="sum-temp">— °C</div>
                </div>
            </div>
            <div class="sum-card">
                <div class="sum-icon" style="color:var(--purple)">💧</div>
                <div>
                    <div class="sum-label">Kel. Udara (rata²)</div>
                    <div class="sum-val" id="sum-airhum">— %</div>
                </div>
            </div>
            <div class="sum-card">
                <div class="sum-icon" style="color:var(--amber)">🌬️</div>
                <div>
                    <div class="sum-label">Tek. Udara (rata²)</div>
                    <div class="sum-val" id="sum-pressure">— hPa</div>
                </div>
            </div>
            <div class="sum-card">
                <div class="sum-icon" style="color:var(--cyan)">🌧️</div>
                <div>
                    <div class="sum-label">Curah Hujan</div>
                    <div class="sum-val" id="sum-rain">— mm</div>
                </div>
            </div>
        </div>
        ...
        <section class="sensor-section acc-green">
            <div class="section-header">
                <div class="section-icon" style="background:rgba(52,211,153,.12);color:var(--green)"><i
                        class="bi bi-moisture"></i></div>
                <div>
                ...
                <span class="badge-count"
                    style="background:rgba(52,211,153,.1);color:var(--green);border:1px solid rgba(52,211,153,.25)">3
                    Alat</span>
            </div>
            <div class="cards-row three-col">
                <div class="sensor-card" id="card-kelembaban-tanah-1">
                    <div class="card-header-row">
                        ...
                        <div class="card-alat-badge" style="background:rgba(52,211,153,.1);color:var(--green)">
                            Kelembaban Tanah</div>
                    </div>
                    <div class="card-value" style="color:var(--green)" id="val-kelembaban-tanah-1">—</div>
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-kelembaban-tanah-1"
                                style="width:0%;background:linear-gradient(90deg,#059669,#34d399)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--green)"></i>
                        kelembaban_tanah_1</div>
                </div>
                <div class="sensor-card" id="card-kelembaban-tanah-2">
                    ...
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-kelembaban-tanah-2"
                                style="width:0%;background:linear-gradient(90deg,#059669,#34d399)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--green)"></i>
                        kelembaban_tanah_2</div>
                </div>
                <div class="sensor-card" id="card-kelembaban-tanah-3">
                    ...
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-kelembaban-tanah-3"
                                style="width:0%;background:linear-gradient(90deg,#059669,#34d399)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--green)"></i>
                        kelembaban_tanah_3</div>
                </div>
            </div>
        </section>
        ...
        <section class="sensor-section acc-blue">
            <div class="section-header">
                <div class="section-icon" style="background:rgba(96,165,250,.12);color:var(--blue)"><i
                        class="bi bi-thermometer-half"></i></div>
                <div>
                ...
                <span class="badge-count"
                    style="background:rgba(96,165,250,.1);color:var(--blue);border:1px solid rgba(96,165,250,.25)">3
                    Alat</span>
            </div>
            <div class="cards-row three-col">
                <div class="sensor-card" id="card-suhu-udara-1">
                    <div class="card-header-row">
                        <div class="card-alat-label">Alat #1</div>
                        <div class="card-alat-badge" style="background:rgba(96,165,250,.1);color:var(--blue)">Suhu
                            Udara</div>
                    </div>
                    <div class="card-value" style="color:var(--blue)" id="val-suhu-udara-1">—</div>
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-suhu-udara-1"
                                style="width:0%;background:linear-gradient(90deg,#1d4ed8,#60a5fa)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--blue)"></i> suhu_udara_1
                    </div>
                </div>
                <div class="sensor-card" id="card-suhu-udara-2">
                    ...
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-suhu-udara-2"
                                style="width:0%;background:linear-gradient(90deg,#1d4ed8,#60a5fa)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--blue)"></i> suhu_udara_2
                    </div>
                </div>
                <div class="sensor-card" id="card-suhu-udara-3">
                    ...
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-suhu-udara-3"
                                style="width:0%;background:linear-gradient(90deg,#1d4ed8,#60a5fa)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--blue)"></i> suhu_udara_3
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="sensor-section acc-purple">
            <div class="section-header">
                <div class="section-icon" style="background:rgba(167,139,250,.12);color:var(--purple)"><i
                        class="bi bi-droplet-half"></i></div>
                <div>
                ...
                <span class="badge-count"
                    style="background:rgba(167,139,250,.1);color:var(--purple);border:1px solid rgba(167,139,250,.25)">3
                    Alat</span>
            </div>
            <div class="cards-row three-col">
                <div class="sensor-card" id="card-kelembaban-udara-1">
                    <div class="card-header-row">
                        <div class="card-alat-label">Alat #1</div>
                        <div class="card-alat-badge" style="background:rgba(167,139,250,.1);color:var(--purple)">
                            Kelembaban Udara</div>
                    </div>
                    <div class="card-value" style="color:var(--purple)" id="val-kelembaban-udara-1">—</div>
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-kelembaban-udara-1"
                                style="width:0%;background:linear-gradient(90deg,#6d28d9,#a78bfa)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--purple)"></i>
                        kelembaban_udara_1</div>
                </div>
                <div class="sensor-card" id="card-kelembaban-udara-2">
                    ...
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-kelembaban-udara-2"
                                style="width:0%;background:linear-gradient(90deg,#6d28d9,#a78bfa)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--purple)"></i>
                        kelembaban_udara_2</div>
                </div>
                <div class="sensor-card" id="card-kelembaban-udara-3">
                    ...
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-kelembaban-udara-3"
                                style="width:0%;background:linear-gradient(90deg,#6d28d9,#a78bfa)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--purple)"></i>
                        kelembaban_udara_3</div>
                </div>
            </div>
        </section>
        ...
        <section class="sensor-section acc-amber">
            <div class="section-header">
                <div class="section-icon" style="background:rgba(251,191,36,.12);color:var(--amber)"><i
                ...
                <span class="badge-count"
                    style="background:rgba(251,191,36,.1);color:var(--amber);border:1px solid rgba(251,191,36,.25)">3
                    Alat</span>
            </div>
            <div class="cards-row three-col">
                <div class="sensor-card" id="card-tekanan-udara-1">
                    <div class="card-header-row">
                        <div class="card-alat-label">Alat #1</div>
                        <div class="card-alat-badge" style="background:rgba(251,191,36,.1);color:var(--amber)">Tekanan
                            Udara</div>
                    </div>
                    <div class="card-value" style="color:var(--amber)" id="val-tekanan-udara-1">—</div>
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-tekanan-udara-1"
                                style="width:0%;background:linear-gradient(90deg,#b45309,#fbbf24)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--amber)"></i>
                        tekanan_udara_1</div>
                </div>
                <div class="sensor-card" id="card-tekanan-udara-2">
                    ...
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-tekanan-udara-2"
                                style="width:0%;background:linear-gradient(90deg,#b45309,#fbbf24)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--amber)"></i>
                ...
                <div class="sensor-card" id="card-tekanan-udara-3">
                    ...
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-tekanan-udara-3"
                                style="width:0%;background:linear-gradient(90deg,#b45309,#fbbf24)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--amber)"></i>
        ...
        <section class="sensor-section acc-cyan">
            <div class="section-header">
                <div class="section-icon" style="background:rgba(34,211,238,.12);color:var(--cyan)"><i
                        class="bi bi-cloud-rain-heavy"></i></div>
                <div>
                    <div class="section-title" style="color:var(--cyan)">Curah Hujan</div>
                    <div class="section-sub">Volume air hujan yang terukur (mm)</div>
                </div>
                <span class="badge-count"
                    style="background:rgba(34,211,238,.1);color:var(--cyan);border:1px solid rgba(34,211,238,.25)">1
                    Alat</span>
            </div>
            <div class="cards-row one-col">
                <div class="sensor-card" id="card-curah-hujan">
                    <div class="card-header-row">
                        <div class="card-alat-label">Alat #1</div>
                        <div class="card-alat-badge" style="background:rgba(34,211,238,.1);color:var(--cyan)">Curah
                            Hujan</div>
                    </div>
                    <div class="card-value" style="color:var(--cyan)" id="val-curah-hujan">—</div>
                    <div class="bar-wrap">
                        <div class="bar-track">
                            <div class="bar-fill" id="bar-curah-hujan"
                                style="width:0%;background:linear-gradient(90deg,#0e7490,#22d3ee)"></div>
                        </div>
                    </div>
                    <div class="card-col-name"><i class="bi bi-database" style="color:var(--cyan)"></i> curah_hujan
                    </div>
                </div>
            </div>
        </section>
    ...
    <script>
        ...
        function updateSummary(d) {
            ...
            document.getElementById('sum-soil').textContent = fmtAvg([v('kelembaban_tanah_1'), v('kelembaban_tanah_2'), v(
                'kelembaban_tanah_3')], 1, '%');
            document.getElementById('sum-temp').textContent = fmtAvg([v('suhu_udara_1'), v('suhu_udara_2'), v(
                'suhu_udara_3')], 1, '°C');
            document.getElementById('sum-airhum').textContent = fmtAvg([v('kelembaban_udara_1'), v('kelembaban_udara_2'), v(
                'kelembaban_udara_3')], 1, '%');
            document.getElementById('sum-pressure').textContent = fmtAvg([v('tekanan_udara_1'), v('tekanan_udara_2'), v(
                'tekanan_udara_3')], 1, 'hPa');
            document.getElementById('sum-rain').textContent = v('curah_hujan') != null ? Number(v('curah_hujan')).toFixed(
                1) + ' mm' : '— mm';
        }
